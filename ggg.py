...
# Key
# a10479a474eb41b18d35b6d7ef8df2a6
# Secret
# 6276cb3c166747aeb5496f53975cfd5d
# https://api.bittrex.com/api/v1.1/public/getticker?market=ada-usd


# 2.166230×8900 = 19279.447
# after 0.35 deduction 19211.969378064
# import random
...
# message = "wtf"
# print(xor_bytes(generate_key_stream(len(message)), message));
...
# print(xor_bytes(generate_key_stream(5), "wtfss"))
...
# cipher = xor_bytes(key, message.encode())
# print(cipher);
# print(xor_bytes(cipher, key))

print(bytes(["abc".encode()[i] ^ "def".encode()[i] for i in range(3)]))
